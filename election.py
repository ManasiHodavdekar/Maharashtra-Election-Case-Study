...
for f in ['E:\\python\\classes\\datasets\\2009maharashtraresults.xlsx','E:\\python\\classes\\datasets\\2014maharashtraresults.xlsx']:
    data=pd.read_excel(f,'Sheet1')
    df=df.append(data)
df.to_excel('E:\\python\\classes\\datasets\\CombinedData.xlsx')
data=pd.read_excel('E:\\python\\classes\\datasets\\CombinedData.xlsx')
print(data)
...
print("The change in perfomance is as follows")
for i in data['PARTYNAME']:
    x=i
